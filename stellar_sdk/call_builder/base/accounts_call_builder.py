...
TAccountsCallBuilder = TypeVar("TAccountsCallBuilder", bound="AccountsCallBuilder")
...
class AccountsCallBuilder(BaseCallBuilder):
    ...
    def account_id(self, account_id: str) -> TAccountsCallBuilder:
    ...
    def for_signer(self, signer: str) -> TAccountsCallBuilder:
    ...
    def for_asset(self, asset: Asset) -> TAccountsCallBuilder:
    ...
    def for_sponsor(self, sponsor: str) -> TAccountsCallBuilder:
